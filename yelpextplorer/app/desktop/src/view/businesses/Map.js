Ext.define('YelpExtplorer.view.businesses.Map', {
    ...
    requiredScripts: [         '//maps.googleapis.com/maps/api/js?key=AIzaSyA9-bjvcLl71U0ZbmCyN99Zv3jnhC2IjXo'  ],
    config: {
        store: null,
        selection: null,
        location: null,
    ...
    updateLocations: function(locations) {
        ...
        Ext.Array.forEach(locations, function(coordinate) {
            ...
            google.maps.event.addListener(marker, "click", function() {
                ...
                me.fireEvent('itemclick', me, marker.coordinate, coordinate.record);
            });
        });
   },
    ...
    updateStore: function(store) {
        if (store) {
            ...
            this.getStore().on('load', function(store) {
                me._calculateMarkers(store);
            }, me);
            me._calculateMarkers(store);
        }
    },

    _calculateMarkers: function(store) {
        var locations = [];
